...
class Follower:
  ...
  def image_callback(self, msg):
    ...
    # follow yellow path
    if not self.stop and M_yellow['m00'] > 0 and M_blue['m00'] == 0 and M_green['m00'] == 0:
    ...
    elif self.stop and M_yellow['m00'] > 0 and M_blue['m00'] == 0 and M_green['m00'] == 0:
      cx = int(M_yellow['m10']/M_yellow['m00'])
      cy = int(M_yellow['m01']/M_yellow['m00'])
      cv2.circle(image, (cx, cy), 20, (0,0,255), -1)
      # BEGIN CONTROL
    ...
    # turn right
    elif not self.stop and M_blue['m00'] > 0 and M_green['m00'] == 0:
